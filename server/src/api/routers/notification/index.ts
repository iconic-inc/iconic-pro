...
router.get(
  '/',
  hasPermission('notification', 'readAny'),
...
router.put(
  ...
  hasPermission('notification', 'updateAny'),
  NotificationController.markAsRead
);

router.delete(
  '/:notificationId',
  hasPermission('notification', 'deleteAny'),
...
router.post(
  '/admin/create',
  hasPermission('notification', 'createAny'),
