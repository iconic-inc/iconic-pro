...
export default function JobApplicationEditForm({
  jobApp,
}: {
  jobApp: IJobApplicationDetails;
}) {
  ...
  const handleCancel = () => {
    navigate(`/admin/job-applications/${jobApp.id}`);
  };
      ...
      <div className='mx-auto bg-white rounded-lg shadow-sm overflow-hidden'>
        ...
        <div>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4 bg-white rounded-lg shadow-sm p-6'>
            {/* Top Left Column - JobApplication Info */}
              ...
              <div className='space-y-4'>
                <div className='flex gap-4'>
                  <TextInput
                    ...
                    name='lastName'
                    type='text'
                    placeholder='Nhập họ Đơn ứng tuyển'
                  ...
                  <TextInput
                    ...
                    name='firstName'
                    type='text'
                    placeholder='Nhập tên Đơn ứng tuyển'
                    autoFocus
                    required
            ...
            <div className='bg-white border border-gray-100 rounded-md p-5 shadow-sm hover:shadow-md transition'>
              ...
              <div className='space-y-4'>
                <TextInput
                  ...
                  defaultValue={jobApp.can_skills?.join(', ')}
                />
                ...
                <TextAreaInput
                  ...
                  defaultValue={jobApp.can_experience}
                />
                ...
                <TextAreaInput
                  ...
                  defaultValue={jobApp.can_summary}
                />
              </div>
            </div>
