...
export default function SpaOwnerToolbar({
  visibleColumns,
  setVisibleColumns,
}: {
          ...
          <div className='absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg border border-gray-200 z-10'>
            <div className='p-3 space-y-2'>
              <label className='flex items-center gap-2'>
                <input
                  type='checkbox'
                  checked={visibleColumns.usr_firstName}
                  onChange={() => handleColumnVisibilityChange('usr_firstName')}
              ...
              <label className='flex items-center gap-2'>
                <input
                  type='checkbox'
                  checked={visibleColumns.usr_msisdn}
                  onChange={() => handleColumnVisibilityChange('usr_msisdn')}
                  className='rounded text-blue-500'
                />
              ...
              <label className='flex items-center gap-2'>
                <input
                  type='checkbox'
                  checked={visibleColumns.usr_email}
                  onChange={() => handleColumnVisibilityChange('usr_email')}
                  className='rounded text-blue-500'
                />
                <span>Email</span>
              </label>
              <label className='flex items-center gap-2'>
                <input
                  type='checkbox'
                  checked={visibleColumns.usr_address}
                  onChange={() => handleColumnVisibilityChange('usr_address')}
                  className='rounded text-blue-500'
                />
                <span>Địa chỉ</span>
              </label>
